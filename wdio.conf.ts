   ...
   // baseUrl: 'https://the-internet.herokuapp.com/',
     ...
     */
        ...
        before: async function () {
            try {
            const response = await axios.post('https://i3v2api-qa.simplifyi3.com/api/TokenAuth/Authenticate', {
                userNameOrEmailAddress: 'Shekhar',
                password: '123qwe'
            });
            const token = response.data.result.accessToken;

            await browser.url("https://i3v2-qa.simplifyi3.com/app/main/home");
            await browser.setCookies([{ name: 'Abp.AuthToken', value: token }]);
            } catch (error) {
